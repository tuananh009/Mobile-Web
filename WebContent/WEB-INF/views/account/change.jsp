...
<jsp:include page = "../layout/head.jsp">
	<jsp:param name="titlePage" value="Thay đổi mật khẩu" />
</jsp:include>
	...
	<div class="row">
		<div class="col-sm-4">
			...
			<li class="nav-item2 " style="list-style-type: none;">
				<a class="nav-link collapsed" href="${rootpath}account/edit" ata-toggle="collapse" id="i">
					<div class="row">
						<div class="col-sm-2">
			...
			<div class="quan-li-thong-tin">
				<li class="nav-item2 active" style="list-style-type: none;">
					<a class="nav-link collapsed" href="${rootpath}account/change" data-toggle="collapse" data-target="#collapseNews" aria-expanded="true" aria-controls="collapseNews">
						<div class="row">
							<div class="col-sm-2">
			...
			<li class="nav-item2" style="list-style-type: none;">
				<a class="nav-link collapsed" href="${rootpath}order/list" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
					<div class="row">
						<div class="col-sm-2">
		...
		<div class="col-sm-8">
			<div class="ct1">
				<div>
					...
					<form:form action="${rootpath}account/change" method="post" modelAttribute="form" enctype="multipart/form-data">
						<br>
						<br/>
						<div class="row">
							<div class="col-sm-4">
