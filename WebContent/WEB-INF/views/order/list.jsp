...
<jsp:include page = "../layout/head.jsp">
	<jsp:param name="titlePage" value="Sản phẩm đã mua" />
</jsp:include>
	...
	<div class="row">
		<div class="col-sm-4">
			...
			<li class="nav-item2 " style="list-style-type: none;"><a
				class="nav-link collapsed" href="${rootpath}account/edit"
			...
			<li class="nav-item2 " style="list-style-type: none;"><a
				class="nav-link collapsed" href="${rootpath}account/change"
							...
							<c:forEach var="o" items="${orders}">
								<tr>
									...
									<td><f:formatNumber value="${o.amount}" pattern="#,###" />
										VNĐ</td>
									<td><a href="${rootpath}order/detail/${o.id}"
