...
<c:forEach var="p" items="${favo}">
	<div class="col-sm-3" style="padding: 5px 5px 5px 5px">
		<div class="thumbnail">
			...
			<a href="${rootpath}product/detail/${p.id}" >
				...
				<img style="margin-right: 30px;margin-top: 5px" class="estore-prod" src="${pageContext.request.contextPath}/<c:url value="static"/>/images/products/${p.image}" title="${p.name}">
			</a>
