...
<jsp:include page = "../layout/head.jsp">
	<jsp:param name="titlePage" value="Giỏ hàng" />
</jsp:include>
...
<%@include file="../layout/menu.jsp"%>
	...
	<div class="ct1">
						...
						<c:forEach var="p"
							...
							<tr data-id="${p.id}" data-price="${p.unitPrice}"
								...
								<td style="width: 120px; padding: 10px 0px 10px 0px;"><img
									src="${pageContext.request.contextPath}/<c:url value ="static"/>/images/products/${p.image}" width="100%"></td>
		...
		<div class="text-center" style="font-size: 18px; padding-bottom: 30px">
			...
			<a href="${rootpath}home" class="btn btn-sm btn-info">Tiếp tục mua hàng</a> 
			<a href="${rootpath}order/checkout" class="btn btn-sm btn-success">Thanh toán</a>
		</div>
	</div>
