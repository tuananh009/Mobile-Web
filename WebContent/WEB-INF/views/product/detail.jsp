...
<jsp:include page = "../layout/head.jsp">
	<jsp:param name="titlePage" value="${prod.name}" />
</jsp:include>
			...
			<div class="row">
				<div class="col-sm-5">
					...
					<div class="product-image">
						<img src="${pageContext.request.contextPath}/<c:url value ="static"/>/images/products/${prod.image}"
							title="${prod.name}">
					</div>
				</div>
				<div class="col-sm-7">
					<div class="san-pham-ct">
						...
						<br /> <a href="${rootpath}product/detail/${prod.id}"> <c:choose>
					...
					<div class="sp-km">
						...
						<p>
							<img style="margin-top: -5px"
								src="${pageContext.request.contextPath}/<c:url value="static"/>/images/icon/icon_km.png" width="15px" height="15px">
				...
				<c:forEach var="p" items="${list}" begin="0" end="7">
					<div class="col-sm-3" style="padding: 5px 5px 5px 5px">
						<div class="thumbnail">
							...
							<a href="${rootpath}product/detail/${p.id}"> <c:choose>
								...
								class="estore-prod" src="${pageContext.request.contextPath}/<c:url value="static"/>/images/products/${p.image}"
								title="${p.name}">
							</a>
...
<jsp:include page="../product/dialog_cart.jsp" />
