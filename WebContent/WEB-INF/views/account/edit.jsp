...
<jsp:include page = "../layout/head.jsp">
	<jsp:param name="titlePage" value="Sửa thông tin Khách Hàng" />
</jsp:include>
	...
	<div class="row">
		<div class="col-sm-4">
			...
			<li class="nav-item2" style="list-style-type: none;"><a
				class="nav-link collapsed" href="${rootpath}order/list"
		...
		<div class="col-sm-8">
			<div class="ct1">
				<div>
					...
					<hr>
					<form:form action="${rootpath}account/edit" modelAttribute="form" enctype="multipart/form-data">
					<h4 class="label label-success">${message}</h4>
						...
						<div class="row">
							...
							<div class="col-sm-8">
								<p>
									<img src="${pageContext.request.contextPath}/<c:url value ="static"/>/images/customers/${form.photo}"
										style="width: 80px; height: 90px;" /> <input type="file"
										name="photo_file" accept=".jpg, .png"/>
