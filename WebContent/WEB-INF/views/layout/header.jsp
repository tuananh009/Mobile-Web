...
<header>
	<img src="${pageContext.request.contextPath}/<c:url value="static"/>/images/footads-new.png" alt="" width="100%" height="100px">
</header>
	...
	<div class="container ">
		<div class="row" style="padding: 20px 15px 12px;">
			<div class="col-sm-4" style="margin-top: -10px;">
				<a href="${rootpath}"><img src="${pageContext.request.contextPath}/<c:url value="static"/>/images/logo1.png" alt="" width="60%"></a>
			</div>
			<div class="col-sm-4" style="padding-right: 15px;">
				<div class="input-group">
					<form action="${rootpath}product/list-by-keywords" method="post">
								...
								<div class="card-sp">
									<ul>
										<li style="list-style-type: none">
											...
											<p class="carts"><a href="${rootpath}cart/view" style="text-decoration: none; color: #003333">Giỏ hàng</a></p>
											<ul>
												<li style="list-style-type: none">
													<div class="row">
														<c:choose>
															<c:when test="${cart.amount > 0}">
																<c:forEach var="p"
																	...
																	<div class="col-sm-4">
																		<img src="${pageContext.request.contextPath}/<c:url value="static"/>/images/products/${p.image}" alt=""  width="100%">
																	</div>
																	<div class="col-sm-8">
											...
											<div class="tong-tien">
												...
												<div>
													<a style="width: 360px "  class="btn btn-primary"
														href="${rootpath}cart/view">Xem giỏ hàng</a>
												</div>
											</div></li>
									</ul>
								</div>
					...
					<div class="col-sm-6">
						<div class="header-menu">
							<i class="glyphicon glyphicon-heart" style="font-size: 30px; padding: 0px 5px 0px 5x"></i> 
								<a class="splike" href="${rootpath}product/favo" style="color: #474c51">Yêu thích</a>
						</div>
					</div>
				</div>
			</div>
